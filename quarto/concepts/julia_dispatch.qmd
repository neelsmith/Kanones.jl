...
The `generate` function has multiple methods. This page explains how Julia's dispatch works with those methods.
...
::: {.callout-caution}
Content of this section TBA: need to add a note on how irregular forms are returned.
:::
