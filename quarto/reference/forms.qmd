...
The kanones github repository includes a [delimited-text list of all  forms](https://github.com/neelsmith/Kanones.jl/blob/main/cexcollections/forms.cex) recognized by Kanones.
:::