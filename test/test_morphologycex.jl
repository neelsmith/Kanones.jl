...
@testset ExtendedTestSet "Test composition of complete CEX for all uninflected forms" begin
    gmfUninflecteds = split(Kanones.uninflectedcex(), "\n")
    @test length(gmfUninflecteds) == 6
end


@testset ExtendedTestSet "Test composition of CEX for uninflected form" begin
...
@testset ExtendedTestSet "Test composition of complete CEX for all noun forms" begin
...
@testset ExtendedTestSet "Test compostion of CEX for noun form" begin
