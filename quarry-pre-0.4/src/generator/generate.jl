...
$(SIGNATURES)
"""
function generate(analysis::Analysis, kd::Kanones.FilesDataset)::Vector{AbstractString}
...
$(SIGNATURES)
"""
function generate(form::FormUrn, lex::LexemeUrn, kd::Kanones.FilesDataset)::Vector{AbstractString}
    # Find "part of speech" value from formurn:
