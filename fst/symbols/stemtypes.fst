...
#neuttau3# = <ma_matos><r_tos><s_tos><s_dos>
#liquidnasal3# = <wr_oros><s_nos><wn_onos><hn_enos><n_nos>
#rho3# = <hr_ros>
#sigma3# = <hs_ous><as_ws>
...
#adj1and2# = <os_h_on><os_a_on><os_h_on_pos><os_h_on_comp><os_h_on_superl><os_on>
